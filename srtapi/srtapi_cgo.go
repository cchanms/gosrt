...
func GetStats(fd int, clear bool) map[string]interface{} {
	...
	output := map[string]interface{}{
		...
		"send": map[string]interface{}{
			...
			"bytes":                	mon.byteSent,
			"bytesSentUnique":	    	mon.byteSentUnique,
		...
		"recv": map[string]interface{}{
			...
			"packetsAvgBelatedTime":    mon.pktRcvAvgBelatedTime,
			"packetsBelated":       	mon.pktRcvBelated,
			"packetsReorderDistance": 	mon.pktReorderDistance,
			"bytes":                	mon.byteRecv,
			"bytesRecvUnique":	    	mon.byteRecvUnique,
